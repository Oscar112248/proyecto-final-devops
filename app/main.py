...
GROUP_NAME = os.getenv("GROUP_NAME", "Grupo 3")
GROUP_MEMBERS = os.getenv("GROUP_MEMBERS", "Daniel Alquinga, Oscar Maldonado")
COURSE_NAME = os.getenv("COURSE_NAME", "Curso de Profesionalizacion en DevOps")
